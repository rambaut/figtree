 ...
 * @version $Id: TreeDrawLabelPainterController.java,v 1.5 2007/08/21 00:05:52 rambaut Exp $
 */
public class TreeDrawLabelPainterController extends AbstractController {
    ...
    public TreeDrawLabelPainterController(String title, String key, final LabelPainter labelPainter) {
        ...
        numericalFormatCombo = new JComboBox(new String[] { "Decimal", "Scientific", "Roman" });
        numericalFormatCombo.addItemListener(new ItemListener() {
            public void itemStateChanged(ItemEvent itemEvent) {
                ...
                if (formatType.equals("Decimal")) {
                    ...
                    labelPainter.setNumberFormat(new Roman());
                }
            }
        });
